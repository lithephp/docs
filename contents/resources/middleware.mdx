...
| [JWT Auth](/resources/middleware/jwt-auth) | Implements authentication based on JSON Web Tokens (JWT), allowing secure user authentication in Lithe applications. This middleware can be installed via Composer and provides an efficient way to manage API authentication. |
